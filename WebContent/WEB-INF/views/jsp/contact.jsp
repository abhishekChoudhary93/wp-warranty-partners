...
<div class="map">
	...
	<section class="contact-w3ls">
		<div class="container">
			<h3
				class="text-center w3layouts w3 w3l w3ls agileits agileinfo wthree w3-agileits">Write
				To Us</h3>
			<p
			...
			<div class="row">
				<form action="#" method="post" name="sentMessage" id="contactForm"
					...
					<div class="col-sm-6 col-sm-6 col-sm-6 contact-agile2">
						<div class="control-group form-group">
							<div class="controls">
						...
						<div class="control-group form-group">
							<div class="controls">
								<label class="contact-p1">Subject:</label> <input type="text"
