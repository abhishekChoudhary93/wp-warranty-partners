...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="container" style="margin: 10%;">
		<div class="row"></div>
		<div class="row">
			<div class="col-md-5 well" style="font-size: 130%;">
				<h3>Message from Warranty Partners:</h3>
				<div class="col-sm-12">
			...
			<div class="col-md-5 well col-sm-offset-2" style="font-size: 130%;">
				...
				<p>
					<strong>Phone: </strong> ${dealer.contactNumber}
				</p>
				<p>
		...
		<div class="row">
			<div class="col-md-12" style="font-size: 130%;">
				<h3>Your Status</h3>
				<br>
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td>Claims</td>
							<td><span class="badge badge-danger">${totalClaims }</span></td>
						</tr>
					</tbody>
				</table>
			</div>
